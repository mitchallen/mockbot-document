module.exports = function (grunt) {
    ...
    grunt.initConfig({
            ...
            dist: {
                options: {
                    browserifyOptions: {
                        ...
                        standalone: 'MitchAllen.-mockbot-document'
                        // standalone: 'mitchallen.-mockbot-document'
                    },
                ...
                files: {
                   ...
                   "./dist/mockbot-document.js": ["./modules/index.js"]
                   // For non-standalone, use ./browser.js instead.
                   // "./dist/mockbot-document.js": ["./browser.js"]
                }
            }
        },
        ...
        uglify: {
            my_target: {
                files: {
                    './dist/mockbot-document.min.js': ['./dist/mockbot-document.js']
                }
            }
        },
